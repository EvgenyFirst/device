...
var modalIframe = document.querySelector(".modal__iframe");

buttonOpenTheMap.addEventListener("click", function (linkGoDefault) {
  linkGoDefault.preventDefault(),
  modalMap.classList.add("modal__map-opened");
  modalIframe.focus();
}),
closeModalMap.addEventListener("click", function (linkGoDefault) {
  linkGoDefault.preventDefault(),
  modalMap.classList.remove("modal__map-opened");
  }),
