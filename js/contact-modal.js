...
buttonOpenContacts.addEventListener("click", function (goDefault) {
  goDefault.preventDefault(), modalContacts.classList.add("modal__contacts-opened");
}),
closeModalContacts.addEventListener("click", function (goDefault) {
  goDefault.preventDefault(), modalContacts.classList.remove("modal__contacts-opened");
  }),
